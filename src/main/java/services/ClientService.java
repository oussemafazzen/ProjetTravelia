...
public class ClientService implements IService<Client> {
    ...
    public void add(Client client) throws SQLException {
        String req = "INSERT INTO client (nom, prenom, email, password, telephone, nationalite, date_naissance, role, statut, date_creation, derniere_connexion, points_fidelite, niveau_fidelite, google_id, email_confirmed) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        try (PreparedStatement ps = cnx.prepareStatement(req, Statement.RETURN_GENERATED_KEYS)) {
            ...
            ps.setString(14, client.getGoogleId());
            ps.setBoolean(15, client.isEmailConfirmed());
